...
def train_mnist(n_epoch: int = 100, device="cuda:0") -> None:
    ...
    ddpm = DDPM(eps_model=UNetEpsModel(1), betas=(1e-4, 0.02), n_T=1000)
    ddpm.to(device)
    ...
    for i in range(n_epoch):
        ...
        with torch.no_grad():
            ...
            save_image(grid, f"UNetEpsModel_ddpm_sample_{i}.png")

            # save model
            torch.save(ddpm.state_dict(), f"./UNetEpsModel_ddpm_mnist.pth")
